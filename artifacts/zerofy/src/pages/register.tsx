    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-mono uppercase tracking-tight">Operative Registration</h1>
          <p className="text-muted-foreground mt-2">Initialize your telemetry profile.</p>
        </div>

        <Card className="border-primary/20 bg-card/50 backdrop-blur-xl">
          <CardHeader>
            <CardTitle>Clearance Request</CardTitle>
            <CardDescription>Join the global mission to reduce emissions.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-mono text-xs uppercase text-muted-foreground">Designation (Name)</FormLabel>
                      <FormControl>
                        <Input placeholder="John Doe" className="font-mono bg-background/50" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-mono text-xs uppercase text-muted-foreground">Identifier (Email)</FormLabel>
                      <FormControl>
          ...
          <CardFooter className="flex justify-center border-t border-border/50 pt-6">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/login" className="text-primary hover:underline font-mono uppercase text-xs">
                Access Terminal
              </Link>
            </p>
          </CardFooter>
